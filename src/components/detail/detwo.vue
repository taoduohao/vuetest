    ...
    <div class="detail-main">
      ...
      <div>
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="有效时间"  prop="resource">
          ...
          <el-form-item label="价格"  prop="price">
            <el-input v-model="price" placeholder="请输入内容" :disabled="true" style="width:220px;"></el-input>
          </el-form-item>
          <el-form-item>
...
<script>
  export default {
    ...
    methods: {
    	handleChange() {
    		this.price = this.oldprice * this.num1
    	},
      submitForm(formName) {
